...
export default function FatturaSimulataPage() {
  ...
  return (
    <main className="min-h-screen p-4 md:p-8">
      <div className="mx-auto max-w-5xl rounded-[28px] border border-slate-300/80 bg-white/90 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.12)] backdrop-blur-sm md:p-8 print:shadow-none">
        <header className="border-b border-slate-200 pb-6">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-slate-950">Fattura Simulata</h1>
